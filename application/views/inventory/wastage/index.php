              ...
              <?php if ($data) : 
                ...
                foreach($data as $row) { ?> 
                  <tr>
                    ...
                    <td nowrap>
                      <button onClick="Edit(<?= $row['wastage_id']; ?>)" class="btn btn-success"><i class="fa fa-edit"></i></button>
                      <button onClick="Delete(<?= $row['wastage_id']; ?>)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                    </td>
                  </tr>
                  <?php $i++; }  ?>
              <?php endif; ?>
