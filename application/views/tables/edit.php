...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <form action="<?php echo base_url() ?>Table/update" method="post" name="addtable" id="addtable" class="form-horizontal">
            <div class="card-body row">          
              <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="tablename" name="tablename" value="<?php echo $formdata['data']['tablename'];?>" autocomplete="off" class="form-control" required/>
                </div>
                <div class="form-group">
                  <label for="inputSubject">Capacity</label>
                  <input type="text" id="capacity" name="capacity" autocomplete="off" value="<?php echo $formdata['data']['capacity'];?>" onkeypress="return isNumber(event)" class="form-control" required/>
                </div>
                <div class="form-group">
                  <label for="inputMessage">Status</label>
                  <select class="form-control form-control-sm" placeholder="" name="status" required>
                                <option value="0" <?php if($formdata['data']['status'] == 0) { ?> selected <?php } ?> >Available</option>
                                <option value="1" <?php if($formdata['data']['status'] == 1) { ?> selected <?php } ?>>Not Available</option>                                
                            </select>
                </div>
                <input type="hidden" id="id" name="id" value="<?php echo $formdata['data']['table_id']; ?>"/>
                <div class="form-group">
