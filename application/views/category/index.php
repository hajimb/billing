          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>Sr No</th>
                <th>Category Name</th>
                <th><a href="<?php echo base_url('category/create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
              ...
              <?php if ($data) : 
                ...
                <?php foreach ($data as $k => $v) : ?>
                  <tr>
                    ...
                    <td nowrap>
                      <button onClick="Edit(<?= $v['category_id']; ?>)" class="btn btn-success"><i class="fa fa-edit"></i></button>
                      <button onClick="Delete(<?= $v['category_id']; ?>)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                    </td>
                  </tr>
                <?php endforeach ?>
              <?php endif; ?>
