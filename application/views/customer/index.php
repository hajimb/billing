          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>DoA</th>
                <th>Address</th>
                <th><a href="<?php echo base_url('customer/create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
              ...
              <?php if ($data) : 
                ...
                foreach($data as $row) { ?> 
                  <tr>
                    ...
                    <td nowrap>
                      <button onClick="Edit(<?= $row['customer_id']; ?>)" class="btn btn-success"><i class="fa fa-edit"></i></button>
                      <button onClick="Delete(<?= $row['customer_id']; ?>)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                    </td>
                  </tr>
                  <?php $i++; }  ?>
              <?php endif; ?>
