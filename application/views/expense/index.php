              ...
              <?php if ($data) : 
                ...
                foreach ($data as $k => $user_s) : ?>
                  <tr>
                    ...
                    <?php } ?> 
                    <td><?php echo $user_s['expense']?></td>
                    <td><?php echo $user_s['amount']?></td>
                    <td><?php echo $user_s['created_date']?></td>
                    <td nowrap>
                      <button onClick="Edit(<?= $user_s['expense_id']; ?>)" class="btn btn-success"><i class="fa fa-edit"></i></button>
                      <button onClick="Delete(<?= $user_s['expense_id']; ?>)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                    </td>
                  </tr>
                <?php endforeach ?>
              <?php endif; ?>
