          ...
          <table id="mainTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>Discount Name</th>
                <th>Discount</th>                                                       
                <th><a href="<?php echo base_url('discount/create') ?>" class="btn btn-default">Add New</a></th>
              </tr>
            </thead>
              ...
              <?php if ($data) : 
                ...
                <?php foreach ($data as $k => $v) : ?>
                  <tr>
                    ...
                    <td nowrap>
                      <button onClick="Edit(<?= $v['discount_id']; ?>)" class="btn btn-success"><i class="fa fa-edit"></i></button>
                      <button onClick="Delete(<?= $v['discount_id']; ?>)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                    </td>
                  </tr>
                <?php endforeach ?>
              <?php endif; ?>
